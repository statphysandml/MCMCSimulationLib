...
if __name__ == '__main__':
    ...
    os.chdir("../../")
    # Generates plots of the correlation time in examples/results/IsingModelSimulationWithCorrelationTime and
    ...
    correlation_time(files_dir="IsingModelSimulationWithCorrelationTime")

    from pystatplottools.utils.utils import load_json
    correlation_times = load_json("./results/IsingModelSimulationWithCorrelationTime/correlation_time_results.json")
