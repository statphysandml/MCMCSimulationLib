...
namespace mcmc {
    namespace simulation {
        ...
        class SystemBaseMeasuresParameters : public param_helper::params::Parameters {
        public:
            SystemBaseMeasuresParameters(const json params_) : Parameters(params_),
        ...
        template<typename Derived>
        std::vector< std::unique_ptr<common_measures::MeasurePolicy<Derived>> > SystemBaseMeasures<Derived>::generate_systembase_measures(const json& measure_names)
        {
        ...
        template<typename Derived>
        void SystemBaseMeasures<Derived>::concat_measures(
                std::vector<std::unique_ptr<common_measures::MeasurePolicy<Derived>>> &measures_) {
