...
namespace mcmc {
    namespace cmd {
        ...
        struct PathParameters {
             ...
             *
             * @param files_dir_ Identifier of the current simulation (the directory is used for storing files in
             ...
             * @param sim_root_dir_ Relative (to the project_root_dir set by param_helper::fs::prfs::set_relative_path_to_project_root_dir("../")) or absolute path to the simulation directory used for storing the simulation config and results files
             * @param rel_path_ Whether sim_root_dir is the relative (true) or the absolute path (false) to the project_root_dir
             */
            PathParameters(const std::string files_dir_, // 
                    ...
                    rel_gpu_bash_script_path("/gpu_cluster_runs/" + files_dir + "/")
                    {}
            ...
            std::string get_rel_gpu_bash_script_path() const {
                ...
                //          << std::endl;
                param_helper::fs::generate_directory_if_not_present(sim_root_dir + rel_gpu_bash_script_path, rel_path);
