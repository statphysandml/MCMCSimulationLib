...
struct CmdIntSimulation : mcmc::cmdint::CmdIntSim<IsingModelParameters, mcmc::measures::ReadableMeasureParameters>
{
    using mcmc::cmdint::CmdIntSim<IsingModelParameters, mcmc::measures::ReadableMeasureParameters>::CmdIntSim;
    ...
    void prepare() override
    {
        ...
        auto simulation_parameters = mcmc::simulation::SimulationParameters<IsingModelParameters>::prepare_simulation_from_file(
