...
namespace mcmc {
    namespace cmdint {
        ...
        struct PathParameters {
             ...
             *
             * @param target_name Identifier of the current simulation (the directory is used for storing files in
             ...
             * @param sim_root_dir Relative (to the project_root_dir set by param_helper::proj::set_relative_path_to_project_root_dir("../")) or absolute path to the simulation directory used for storing the simulation config and results files
             * @param rel_path Whether sim_root_dir is the relative (true) or the absolute path (false) to the project_root_dir
             */
