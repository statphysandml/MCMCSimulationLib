...
{%- endif %}
{%- if cookiecutter.github_actions_ci == "Yes" or cookiecutter.gitlab_ci == "Yes" or cookiecutter.readthedocs == "Yes" or cookiecutter.codecovio == "Yes" or cookiecutter.sonarcloud == "Yes" %}
