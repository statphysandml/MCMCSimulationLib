...
#include "../include/saving_and_loading/config.h"

#include <mcmc_simulation/header.hpp>
#include <execution/executer.hpp>

#include "../include/saving_and_loading/simulation_header.hpp"
...
/* Example for saving simulation parameters and load simulation from file - On the example of the Execution mode: CorrelationTime */
...
void custom_main() {
    //[ Saving all necessary parameters
    ...
    //[Load all parameters and run the simulation
