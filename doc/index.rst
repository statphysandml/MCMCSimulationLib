...
- Markov chain Monte Carlo simulations for arbitrary models/theories in C++
- A modular structure allowing for a brute force and simple implementation of your model/theory
...
- A bash console/terminal interface allowing for running and preparing simulations solely from configuration files
